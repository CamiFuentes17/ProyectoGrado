    ...
    <div class="content">
      <div class="block block-rounded block-themed">
        <div class="block-header bg-primary-light">
          <h3 class="block-title">Editar <strong>País</strong></h3>
        </div>
          ...
          <form action="{{ route('countries.update',$country->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-3 my-3">
                  ...
                  <input type="text" class="form-control form-control-alt"  name="name"  value="{{$country->name}}" required>
                </div>
                
                <div class="col-md-3 my-3">
                  <label class="form-label" for="example-text-input-alt">ISO </label>
                  <input type="text" class="form-control form-control-alt"  name="ISO"  value="{{$country->ISO}}" required>
                </div>
