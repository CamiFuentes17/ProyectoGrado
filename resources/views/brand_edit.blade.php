    ...
    <div class="content">
      <div class="block block-rounded block-themed">
        <div class="block-header bg-primary-light">
          <h3 class="block-title">Editar <strong>Marca</strong></h3>
        </div>
           ...
           @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-3 my-3">
                  ...
                  <input type="text" class="form-control form-control-alt"  name="name"  value="{{$brand->name}}" required>
                </div>
                ...
                <div class="col-md-3 my-3">
                  ...
                  <option value="{{$brand->country->id}}" selected >{{$brand->country->name}}</option>
                ...
                <div class="col-md-3 my-3">
                  ...
                  <input type="text" class="form-control form-control-alt"  name="url_img"  value="{{$brand->url_img}}" >
                </div>   

                <div class="col-md-3 my-3">
                  <label class="form-label" for="example-text-input-alt">Descripción </label>
                  <input type="text" class="form-control form-control-alt"  name="description"  value="{{$brand->description}}" >
                </div>                
